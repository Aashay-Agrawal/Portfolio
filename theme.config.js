export default {
  ...
  footer: (
    <div className="my-24  border-t-2  mx-auto flex items-center sm:flex-row flex-col">
      <p className="text-sm text-gray-500">© By Aashay Agrawal</p>
      <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
        <a
          target="_blank"
          href="https://twitter.com/wtfaashay"
        ...
        <a
          target="_blank"
          href="https://www.instagram.com/wtf.aashay"
          className="ml-3 text-gray-500"
        >
          <svg
            fill="none"
        ...
        <a
          target="_blank"
          href="https://www.linkedin.com/in/aashayagrawal/"
          className="ml-3 text-gray-500"
        >
          <svg
            fill="currentColor"
